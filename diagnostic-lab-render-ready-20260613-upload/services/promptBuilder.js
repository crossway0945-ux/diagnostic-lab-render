...
- Keep the existing Task 2 diagnostic framework, but apply caps when structural task failures are present.
...
- If examples are generic and do not contain Specific Situation, Action, and Result, cap Task Response at 7.0 maximum, or 6.0-6.5 if development is already weak.
- If a body paragraph ends with a new unrelated point, set intruderSentenceDetected = true and cap Coherence & Cohesion at 6.0-6.5.
