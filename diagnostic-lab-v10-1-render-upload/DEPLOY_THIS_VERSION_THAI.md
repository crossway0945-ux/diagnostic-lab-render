# Deploy IELTS Writing 7+ Diagnostic Lab V10.1

แพ็กเกจนี้เป็น packaging hotfix สำหรับข้อผิดพลาด V10 ที่เกิดโฟลเดอร์ชื่อเดียวกันซ้อนสองชั้น ไฟล์ ZIP V10.1 ถูกสร้างใหม่ให้แตกออกมาเป็นโฟลเดอร์เดียว
...
diagnostic-lab-v10-1-render-upload/server.js
diagnostic-lab-v10-1-render-upload/services/apiRouter.js
diagnostic-lab-v10-1-render-upload/services/task1Safety.js
diagnostic-lab-v10-1-render-upload/services/task2Safety.js
diagnostic-lab-v10-1-render-upload/tests/v10-commercial-sale-readiness.test.mjs
```
...
2. ตรวจ path `diagnostic-lab-v10-1-render-upload/package.json`
