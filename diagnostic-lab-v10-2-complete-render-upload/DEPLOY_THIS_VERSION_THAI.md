# Deploy IELTS Writing 7+ Diagnostic Lab V10.2

แพ็กเกจนี้เป็นโปรเจกต์เต็มชุด ไม่ใช่ hotfix แยกไฟล์ โดยรวมการแก้โฟลเดอร์ซ้อน การอนุญาตให้ browser โหลด `services/task1Safety.js` และ fallback ป้องกันหน้าเขียวไว้แล้ว
...
ภายในโฟลเดอร์ดังกล่าวต้องเห็น `package.json` ทันที ห้ามมีโฟลเดอร์ชื่อเดียวกันซ้อนอีกชั้น
...
```text
diagnostic-lab-v10-2-complete-render-upload/package.json
diagnostic-lab-v10-2-complete-render-upload/server.js
diagnostic-lab-v10-2-complete-render-upload/services/apiRouter.js
diagnostic-lab-v10-2-complete-render-upload/services/task1Safety.js
diagnostic-lab-v10-2-complete-render-upload/services/task2Safety.js
diagnostic-lab-v10-2-complete-render-upload/tests/v10-commercial-sale-readiness.test.mjs
```
...
2. ตรวจ path `diagnostic-lab-v10-2-complete-render-upload/package.json`
