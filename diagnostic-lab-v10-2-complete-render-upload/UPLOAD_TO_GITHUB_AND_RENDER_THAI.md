# วิธีอัปโหลด V10.2 ขึ้น GitHub และ Render

ZIP V10.2 เป็นโปรเจกต์เต็มชุดและรวมการแก้หน้าเขียวแล้ว ภายใน ZIP เป็นไฟล์โปรเจกต์โดยตรง และ Windows จะสร้างโฟลเดอร์ชื่อ ZIP ให้เพียงหนึ่งชั้นตอนใช้ `Extract All`
...
```text
diagnostic-lab-v10-2-complete-render-upload
```

ภายในโฟลเดอร์นี้ต้องเห็น `package.json`, `server.js`, `script.js` และโฟลเดอร์ `services` ทันที

ห้ามมีโฟลเดอร์ชื่อ `diagnostic-lab-v10-2-complete-render-upload` ซ้อนอยู่ข้างในอีกชั้น
