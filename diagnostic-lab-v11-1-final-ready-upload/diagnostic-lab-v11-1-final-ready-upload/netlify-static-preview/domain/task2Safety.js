...
export function reconcileTask2CanonicalAnalysis(payload = {}, providerAnalysis = {}, suppliedSafety = null) {
  ...
  return {
    ...
    consistency: {
      analysisSource: "canonical-analysis-v11.1",
      routeSource: "canonical-analysis-v11.1",
  ...
  for (const criterion of TASK2_CRITERIA) {
    ...
    output[criterion] = typeof source === "object" && source
      ? {
          ...
          scoreSource: "canonical-language-profile-v11.1"
        }
      : { range: formatBandRange(parsed.low, parsed.high), diagnosis: deterministicCriterionDiagnosis(criterion, safety), evidence: "", scoreSource: "canonical-language-profile-v11.1" };
  }
