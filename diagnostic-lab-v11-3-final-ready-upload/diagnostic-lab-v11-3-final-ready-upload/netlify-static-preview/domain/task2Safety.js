  ...
  for (const criterion of TASK2_CRITERIA) {
    ...
    output[criterion] = typeof source === "object" && source
      ? {
          ...
          scoreSource: "canonical-language-profile-v11.3"
        }
      : { range: formatBandRange(parsed.low, parsed.high), diagnosis: deterministicCriterionDiagnosis(criterion, safety), evidence: "", scoreSource: "canonical-language-profile-v11.3" };
  }
