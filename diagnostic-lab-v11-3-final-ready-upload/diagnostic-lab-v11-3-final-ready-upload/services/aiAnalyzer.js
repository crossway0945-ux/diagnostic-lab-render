...
function buildTask2CoverageTopIssueCards(cards, payload) {
  ...
  return [
    ...
    { ...lexical, issueType: "Full-Response Lexical Precision" },
    { ...grammar, issueType: "Full-Response Grammatical and Sentence Control" },
    { ...closure, issueType: "Paragraph Closure and Link-Back" },
    {
      ...introduction,
