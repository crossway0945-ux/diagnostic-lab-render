...
assert.equal(localReport.estimatedBandRange, "6.0-6.5");
...
assert.ok(localReport.top3Issues.some((item) => item.issueType === "Full-Response Grammatical and Sentence Control"));
