...
assert.equal(framing.issueType, "Introduction and Conclusion Precision");
assert.equal(framing.scope, "multi-location");
assert.deepEqual(framing.paragraphLocations, ["Introduction, Sentence 1", "Conclusion, Sentence 1"]);
assert.equal(framing.evidenceItems.length, 2);
