...
assert.match(css, /font-family: "Noto Sans Thai", Arial, sans-serif/);
assert.match(script, /[\\u200B\\u2060]/);
...
for (const approved of [
  ...
  "concentrating similar facilities in separate districts would reduce accessibility and worsen traffic congestion"
]) assert.match(analyzer, new RegExp(approved.replace(/[.*+?^${}()|[\]\\]/g, "\\$&"), "i"));
