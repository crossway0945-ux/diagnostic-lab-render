...
function normalizePrintFeedbackCard(card = {}) {
  ...
  if (exact.includes("however, i strongly disagree with the statement due to the lack of travel accessibility")) {
    result.targetedRevision = "However, I strongly disagree because this arrangement could make travel less accessible and worsen traffic congestion.";
    result.revisionType = "Route-Preserving Revision";
  } else if (exact.includes("clusterization of a specific place")) {
    ...
    result.targetedRevision = "In conclusion, I firmly believe that urban areas should not be divided into separate zones for different types of facilities, because this would make travel less accessible and worsen traffic congestion.";
    result.revisionType = "Route-Preserving Revision";
  }
  return result;
}
