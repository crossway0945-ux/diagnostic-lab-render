...
async function exportDiagnosticPdf(_analysis, reportId = currentReportId) {
  ...
  try {
    showToast("Preparing the official server-generated PDF...");
    ...
    showToast("Official PDF generated from a clean server-side browser.");
  } catch (error) {
    showError(error.message || "The PDF report could not be generated.");
  }
}
