...
function composeDeterministicPrintPages(doc) {
  ...
  const createSheet = () => {
    ...
    sheet.style.cssText = "position:relative;box-sizing:border-box;width:100%;height:260mm;margin:0;overflow:visible;background:#fff;";
    const content = doc.createElement("div");
    content.className = "pdf-sheet-content";
    content.style.cssText = "box-sizing:border-box;width:100%;height:249mm;overflow:visible;";
