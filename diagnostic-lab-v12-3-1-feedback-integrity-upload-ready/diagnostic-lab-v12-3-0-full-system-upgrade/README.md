...
- Prompt-driven classification for all supported Task 2 types, including Causes & Effects, Positive/Negative Development and hybrid routes
...
## V11.7 Bilingual Premium Report

The analysis form now supports English and Thai report output. Both languages use the same canonical classification, route analysis, criterion scores and evidence selection. Student quotations and IELTS-ready revisions remain in English, while headings, explanations, actions, the seven-day repair plan and disclaimer follow the selected report language. The print report uses framed major sections and premium issue cards for clearer visual separation.
