...
export const AGREEMENT_VALIDATOR_VERSION = "syntactic-head-agreement-v12.7.0";
...
export function resolveFiniteVerbSubject(text = "", verbStart = -1) {
  ...
  if (coreWords[0] === "a" && coreWords[1] === "number") {
    headToken = coreTokens[1];
    number = "plural";
  } else if (coreWords[0] === "the" && coreWords[1] === "number") {
    headToken = coreTokens[1];
    number = "singular";
