...
CASES = (
    ("regression-thai-v12-7-0.pdf", ("Regression Thai V12.7.0", "Example Development", "Body Paragraph 2, Sentence 3")),
    ("regression-english-v12-7-0.pdf", ("Regression English V12.7.0", "Paragraph Coverage Summary", "Disclaimer")),
)
