...
assert.match(report.kruPomScores["Body Paragraph Route Alignment"].diagnosis, /Body 1.*disagreement.*Body 2.*disagreement/i);
...
assert.match(printCardRule, /break-inside:\s*avoid/);
