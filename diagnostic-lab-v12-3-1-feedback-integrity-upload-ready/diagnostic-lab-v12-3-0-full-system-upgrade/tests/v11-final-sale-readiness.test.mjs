...
await check("revision taxonomy is exact", () => assert.deepEqual([...REVISION_TYPES], ["Minimal Correction", "Route-Preserving Revision", "Teacher-Guided Expansion", "Model Paragraph", "High-Band Refinement"]));
