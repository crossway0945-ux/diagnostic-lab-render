...
assert.equal(ANALYSIS_VERSIONS.promptVersion, "ielts-diagnostic-prompt-v12.6.0");
assert.equal(ANALYSIS_VERSIONS.reportSchemaVersion, "ielts-diagnostic-report-v12.6.0");
...
assert.equal(ANALYSIS_VERSIONS.evidenceValidatorVersion, "evidence-assertion-v12.6.0");
assert.equal(ANALYSIS_VERSIONS.revisionValidatorVersion, "revision-alignment-v12.6.0");
assert.equal(ANALYSIS_VERSIONS.pdfTextIntegrityVersion, "pdf-text-integrity-v12.6.0");
