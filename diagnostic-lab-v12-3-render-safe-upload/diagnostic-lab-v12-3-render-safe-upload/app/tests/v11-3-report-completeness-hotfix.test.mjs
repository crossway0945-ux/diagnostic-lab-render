...
const [script, template, viewModel, fonts] = await Promise.all([
...
console.log("V11.3 report completeness hotfix: evidence cards, five priorities, revision fidelity, PDF layout/text and report-version grouping checks passed.");
