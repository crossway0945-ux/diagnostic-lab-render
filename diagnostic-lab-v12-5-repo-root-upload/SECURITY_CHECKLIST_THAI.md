...
- แพ็กเกจนี้ไม่พึ่ง dotfile ตอนอัปโหลดผ่านเบราว์เซอร์ ให้ตรวจด้วยตนเองว่าไม่มี data/log/secret, `.env`, `node_modules` หรือรายงานจริงปะปน
...
- Root Directory ต้องเป็น `diagnostic-lab-v12-3-render-safe-upload`
- Build Command ต้องเป็น `bash render-build.sh`
- Start Command ต้องเป็น `bash render-start.sh`
