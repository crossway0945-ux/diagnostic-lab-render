...
export function classifyTask2Prompt(payload = {}) {
  ...
  return {
    ...
    promptSubtype: effectiveInternalSubtype === TASK2_INTERNAL_SUBTYPES.OUTWEIGH ? "outweigh" : "",
    outweighDirection: effectiveInternalSubtype === TASK2_INTERNAL_SUBTYPES.OUTWEIGH
      ...
      : "",
    comparisonRequired: effectiveInternalSubtype === TASK2_INTERNAL_SUBTYPES.OUTWEIGH,
