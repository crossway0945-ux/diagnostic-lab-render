...
export function buildEvidenceBasedRepairPlan(issues = [], reportLanguage = "en", requiredDays = 7, context = {}) {
  ...
  if (qualifiedState?.qualified && unique.length) {
    ...
    const plan = [
      [routeIssue, "Qualified thesis", "Write one qualified judgement: reject blanket zoning and state the limited exception."],
      [body1Issue, "Exception paragraph", "Make Body Paragraph 1 the limited safety exception."],
      [body2Issue, "Main disagreement", "Make Body Paragraph 2 prove why the blanket rule fails."],
      [fragments[0] || body1Issue, "Fragments", "Turn the two validated fragments into complete independent clauses."],
      [damagedBody, "Severe clause control", "Rebuild the structurally damaged Body Paragraph 1 sentence with a clear subject and finite verb."],
      [recurringLanguage, "Recurring language", "Repair recurring verb-complement, word-form, spelling and modifier/collocation errors."],
      [routeIssue, "Transfer", "Write a new qualified Opinion response with one exception paragraph and one main-position paragraph."]
    ];
