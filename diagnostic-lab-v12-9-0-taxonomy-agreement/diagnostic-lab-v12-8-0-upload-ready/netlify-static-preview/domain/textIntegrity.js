...
// UTF-8 bytes for U+FFFE/U+FFFF/U+FFFD sometimes survive a second decode as
// visible mojibake. These are not raw noncharacters, so code-point checks alone
// cannot find strings such as "Subjectï¿¾Verb Agreement".
const MOJIBAKE_SEPARATOR_PATTERN = /(?:\u00ef\u00bf\u00be|\u00ef\u00bf\u00bf|\u00ef\u00bf\u00bd|\u00c3\u00af\u00c2\u00bf\u00c2\u00be|\u00c3\u00af\u00c2\u00bf\u00c2\u00bf|\u00c3\u00af\u00c2\u00bf\u00c2\u00bd)/gu;
...
export function sanitizePrintableText(value) {
  const restored = String(value ?? "")
    ...
    .replace(/(?<=[A-Za-z])(?:\u00ef\u00bf\u00be|\u00ef\u00bf\u00bf|\u00ef\u00bf\u00bd|\u00c3\u00af\u00c2\u00bf\u00c2\u00be|\u00c3\u00af\u00c2\u00bf\u00c2\u00bf|\u00c3\u00af\u00c2\u00bf\u00c2\u00bd)(?=[A-Za-z])/gu, "-")
...
export function printableTextViolations(value) {
  ...
  if (MOJIBAKE_SEPARATOR_PATTERN.test(text)) violations.push("MOJIBAKE_SEPARATOR_SEQUENCE");
  MOJIBAKE_SEPARATOR_PATTERN.lastIndex = 0;
...
export function unicodeIntegrityIssues(value, options = {}) {
  ...
  CORRUPTED_SEPARATOR_PATTERN.lastIndex = 0;
  if (MOJIBAKE_SEPARATOR_PATTERN.test(text)) issues.push("MOJIBAKE_SEPARATOR_SEQUENCE");
  MOJIBAKE_SEPARATOR_PATTERN.lastIndex = 0;
