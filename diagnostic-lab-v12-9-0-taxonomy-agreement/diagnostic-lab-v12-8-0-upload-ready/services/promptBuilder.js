...
- In an Opinion essay, a limited exception or concession can coexist with the controlling agree/disagree judgement. Classify it from the thesis, body roles and conclusion together; do not treat the exception alone as a route contradiction.
- If the conclusion clarifies a qualified position that the thesis stated incompletely or locally contradicted, preserve the final qualified position but do not rate Position Clarity or Thesis Route Clarity as Strong. Report the thesis repair explicitly.
