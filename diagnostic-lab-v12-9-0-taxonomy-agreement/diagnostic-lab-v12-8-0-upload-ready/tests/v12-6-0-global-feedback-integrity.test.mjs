...
assert.equal(ANALYSIS_VERSIONS.engineVersion, "ielts-diagnostic-engine-v12.9.8");
...
assert.equal(ANALYSIS_VERSIONS.reportSchemaVersion, "ielts-diagnostic-report-v12.9.8");
assert.equal(ANALYSIS_VERSIONS.feedbackSchemaVersion, "feedback-integrity-v12.9.8");
assert.equal(ANALYSIS_VERSIONS.issueTaxonomyVersion, "issue-taxonomy-v12.9.8");
assert.equal(ANALYSIS_VERSIONS.evidenceValidatorVersion, "framework-evidence-contract-v12.9.8");
assert.equal(ANALYSIS_VERSIONS.revisionValidatorVersion, "revision-alignment-v12.8.0");
assert.equal(ANALYSIS_VERSIONS.pdfTextIntegrityVersion, "pdf-text-integrity-v12.9.8");
