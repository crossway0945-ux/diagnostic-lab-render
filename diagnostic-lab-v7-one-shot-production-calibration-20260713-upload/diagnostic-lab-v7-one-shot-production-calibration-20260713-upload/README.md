...
Upload the extracted `diagnostic-lab-v7-one-shot-production-calibration-20260713-upload` folder to the repository root. Set Render **Root Directory** to that exact folder name; do not append `/package.json` or a trailing slash.
