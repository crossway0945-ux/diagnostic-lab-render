...
- Label every feedback-card revision as exactly one of: Minimal Correction, Route-Preserving Revision, Teacher-Guided Recommended Route, Teacher-Guided Expansion, or Model Paragraph.
...
- canonicalEssayType: ${safety.canonicalAnalysis?.essayType || safety.essayRoute || "not preclassified"}
- canonicalEssayTypeLabel: ${safety.canonicalAnalysis?.essayTypeLabel || "not preclassified"}
...
- Problem & Solution: assess requested causes/problems, solutions, pairing and conclusion closure. Never use supports/opposes-the-proposition wording.
...
Return JSON with this top-level shape:
{
  ...
  "revisedThesisRevisionType": "Route-Preserving Revision | Teacher-Guided Recommended Route | Teacher-Guided Expansion",
  "criteriaScores": {
  ...
  "feedbackCards": [
    {
      ...
      "kruPomDiagnosis": "...",
      "targetedRevision": "...",
      "revisionType": "Minimal Correction | Route-Preserving Revision | Teacher-Guided Recommended Route | Teacher-Guided Expansion | Model Paragraph",
