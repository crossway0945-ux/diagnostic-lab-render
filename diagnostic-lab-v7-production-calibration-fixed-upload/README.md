...
- Canonical six-type Task 2 classification and task-requirement routing
...
- Student profile archive/restore without deleting history or account credits
...
Upload the extracted `diagnostic-lab-v7-production-calibration-fixed-upload` folder to the repository root. Set Render **Root Directory** to that exact folder name; do not append `/package.json`, a trailing slash, or a second nested copy of the folder name.
