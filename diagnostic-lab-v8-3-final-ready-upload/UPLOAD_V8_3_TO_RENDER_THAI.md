...
```text
diagnostic-lab-v8-3-final-ready-upload
```

## 1. อัปโหลดเข้า GitHub

1. แตกไฟล์ ZIP
2. จะเห็นโฟลเดอร์ `diagnostic-lab-v8-3-final-ready-upload` และเมื่อเปิดโฟลเดอร์นี้จะพบ `package.json` ทันที ไม่มีโฟลเดอร์ซ้อน
3. เปิด repository `diagnostic-lab-render` ใน GitHub
4. เลือก `Add file` > `Upload files`
5. ลากโฟลเดอร์ `diagnostic-lab-v8-3-final-ready-upload` เข้าไปทั้งโฟลเดอร์
...
```text
Root Directory: diagnostic-lab-v8-3-final-ready-upload
