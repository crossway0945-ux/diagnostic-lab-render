...
The V8.3 release ZIP contains one upload folder named `diagnostic-lab-v8-3-task2-taxonomy-final-upload`. Upload that whole folder to GitHub and use the same name as the Render **Root Directory**. See `UPLOAD_V8_3_TO_RENDER_THAI.md` for the exact steps.
