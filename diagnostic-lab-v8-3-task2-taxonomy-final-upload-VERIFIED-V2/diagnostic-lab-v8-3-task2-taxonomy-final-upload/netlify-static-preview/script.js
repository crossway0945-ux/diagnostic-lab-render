...
function studentMessageForError(errorCode, fallbackMessage) {
  const messages = {
    ...
    ESSAY_TYPE_SELECTION_REQUIRED: "The essay family could not be identified safely. Please choose one of the five Task 2 essay families, then analyze again.",
    ESSAY_TYPE_MISMATCH: fallbackMessage,
